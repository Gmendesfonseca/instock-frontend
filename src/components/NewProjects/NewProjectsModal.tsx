...
const NewProjectModal: React.FC<NewProjectModalProps> = ({
  ...
  const handleProductSelect = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    setSelectedProducts((prevSelectedProducts) => {
      ...
      updateItems(newSelectedProducts);
  ...
  const updateItems = (selectedProducts: { [key: string]: number }) => {
    const newItems = Object.keys(selectedProducts).map((productId) => ({
  ...
  return (
    <div className='new_projects_modal'>
      <div className='new_projects_modal_content'>
        <section className='new_projects_modal_header'>
